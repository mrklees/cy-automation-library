...
# The local suite of functions written for this 
...
def import_parameters():
    with open('section-creator-input.csv') as csvfile:
...
def select_subject(driver, section):
    ...
    driver.find_element_by_xpath("//*[contains(text(), '50 Acts of Leadership')]").click()
